...
export const translations = {
  en: {
    ...
    strategyCreatedAt: 'Created',
    strategyUpdatedAt: 'Updated',
    noStrategies: 'No Custom Strategies',
    noStrategiesDesc: 'Create your first custom trading strategy',
    strategyNamePlaceholder: 'e.g., My_Conservative_Strategy',
    strategyDescPlaceholder: 'Brief description of your strategy...',
    strategyContentPlaceholder: 'Enter your trading strategy prompt here...',
    saveStrategy: 'Save Strategy',
    cancelEdit: 'Cancel',
    confirmDelete: 'Are you sure you want to delete this strategy?',
    strategyCreatedSuccess: 'Strategy created successfully',
    strategyUpdatedSuccess: 'Strategy updated successfully',
    strategyDeletedSuccess: 'Strategy deleted successfully',
    strategyNameRequired: 'Strategy name is required',
    strategyContentRequired: 'Strategy content is required',
    strategyNameInvalid:
      'Strategy name can only contain letters, numbers, underscores, and Chinese characters',
  ...
  zh: {
    ...
    verify: '验证',
    verifying: '验证中...',
    otpVerificationFailed: '验证码验证失败',
    otpInstructions: '打开您的验证器应用，输入6位验证码以继续',
    ...
    strategyCreatedAt: '创建时间',
    strategyUpdatedAt: '更新时间',
    noStrategies: '暂无自定义策略',
    noStrategiesDesc: '创建您的第一个自定义交易策略',
    strategyNamePlaceholder: '例如：我的保守策略',
    strategyDescPlaceholder: '简要描述您的策略...',
    strategyContentPlaceholder: '在此输入您的交易策略提示词...',
    saveStrategy: '保存策略',
    cancelEdit: '取消',
    confirmDelete: '确定要删除这个策略吗？',
    strategyCreatedSuccess: '策略创建成功',
    strategyUpdatedSuccess: '策略更新成功',
    strategyDeletedSuccess: '策略删除成功',
    strategyNameRequired: '请输入策略名称',
    strategyContentRequired: '请输入策略内容',
    strategyNameInvalid: '策略名称只能包含字母、数字、下划线和中文',
    systemTemplate: '系统',
    userStrategy: '自定义',
    viewTemplate: '查看模板',
